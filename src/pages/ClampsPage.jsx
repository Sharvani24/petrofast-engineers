...
// Hero image (banner for clamps)
import clampsHero from '../assets/images/3.7/clamps.png';

// Clamp images (based on your folder directory)
import clamp1 from '../assets/images/3.7/3.7.1.png';

const productData = {
  clamps: [
    { name: "Pipe Clamps", img: clamp1 },
  ],
};

const ClampsPage = () => {
  const products = productData.clamps;
  ...
  return (
    <section className="w-full bg-white">
      ...
      <div className="w-full py-16 px-6 md:px-12">
        ...
        {/* Product Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-y-16 gap-x-25 lg:gap-x-32 max-w-[1300px] mx-auto px-4">
