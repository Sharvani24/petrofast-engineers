...
// Hero image (banner for Petrochemical / Pipelines)
import petroHero from '../assets/images/3.10/Petrochemical.png';

// Petrochemical / Pipelines images (based on your folder directory)
import petro1 from '../assets/images/3.10/3.10.1.png';
import petro2 from '../assets/images/3.10/3.10.2.png';

const productData = {
  petrochemical: [
    { name: "Pipeline Fasteners", img: petro1 },
    { name: "Pipeline Fasteners", img: petro2 },
  ],
};

const PetrochemicalPage = () => {
  const products = productData.petrochemical;
  ...
  return (
    <section className="w-full bg-white">
      ...
      <div className="w-full overflow-hidden px-6 md:px-12 mt-6">
        <img
          src={petroHero}
          alt="Petrochemical and Pipeline Fasteners"
