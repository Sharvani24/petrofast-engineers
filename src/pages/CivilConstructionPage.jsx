...
import civilHero from '../assets/images/3.9/Civil Construction Fasteners.png';

// Civil Construction Fasteners images
import civil1 from '../assets/images/3.9/3.9.1.png';
import civil2 from '../assets/images/3.9/3.9.2.png';
import civil3 from '../assets/images/3.9/3.9.3.png';

const productData = {
  civil: [
    { name: "Anchor-Foundation Bolt", img: civil1 },
    { name: "Anchor-Foundation Bolt", img: civil2 },
    { name: "Steel Structure Bolts Nuts", img: civil3 },
  ],
};

const CivilConstructionPage = () => {
  const products = productData.civil;
  ...
  return (
    <section className="w-full bg-white">
      ...
      <div className="w-full overflow-hidden px-6 md:px-12 mt-6">
        <img
          src={civilHero}
          alt="Civil Construction Fasteners"
