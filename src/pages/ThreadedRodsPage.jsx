...
// Hero image (banner for threaded rods/bolts)
import rodsHero from '../assets/images/3.5/Threaded Rods_Bolts.png';

// Threaded Rods/Bolts images (based on your folder directory)
import rod1 from '../assets/images/3.5/3.5.1.png';
import rod2 from '../assets/images/3.5/3.5.2.png';

const productData = {
  rods: [
    { name: "Threaded Rods / Bars", img: rod1 },
    { name: "Threaded Rods / Bars", img: rod2 },
  ],
};

const ThreadedRodsPage = () => {
  const products = productData.rods;
...
export default ThreadedRodsPage;